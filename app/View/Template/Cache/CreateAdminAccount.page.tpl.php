      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <p class="navbar-text "> suivi et évaluation des stagiaires en entreprise|installation|étape 
              <span class="badge"><?php echo'2'; ?></span> sur <span class="badge"><?php echo'11'; ?></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <input type="text" required class="form-control" id="inputAdminName" 
                                           name="<?php echo'_adminName'; ?>" 
                                           placeholder="<?php echo'Nom administrateur'; ?>" 
                                           value="<?php echo''; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <input type="password" required class="form-control" id="inputAdminPass2" 
                                           name="<?php echo'_adminPassConfirm'; ?>" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <input type="email" required class="form-control" id="inputAdminMel" 
                                           name="<?php echo'_adminEmail'; ?>" 
                                           placeholder="<?php echo'mél administrateur'; ?>"
                                           value="<?php echo''; ?>">
                                </div>
                            </div>
                         <!--</form>-->
