...
/**
 * Description of CreateAdminAccountBuilder
 *
 * @author prog
 */
class CreateAdminAccountBuilder extends AViewBuilder{
    
    public function __construct($params) {
        parent::__construct('CreateAdminAccount', $params);
    }
    ...
    public function BuildBody($params){
            $body = TemplateHandler::getTemplate('CreateAdminAccount');
