                    ...
                    <ul class="nav nav-sidebar">
                        <li role="presentation" class="dropdown"> 
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="REFERENTIAL"><span class="glyphicon glyphicon-book " aria-hidden="true"></span>Référentiel de formation</a></li>
                                <li><a href="FUNCTION"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>Fonctions</a></li>
                                <li><a href="ACTIVITY"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>Activités</a></li>
