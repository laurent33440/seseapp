        ...
        <div class="row">
            ...
            <!--<div class="input-group">-->
                <form method="post" action="<?php echo' /sese/index.php '; ?>">
                    ...
                    <button class="btn btn-lg btn-primary btn-block" type="submit" name ="LicenseViewed"> <span class="glyphicon glyphicon-check"></span> Accepter la license et commencer l'installation...</button>
                </form>
            <!--</div> /input-group -->
            </div>
        </div>
