 ...
 * @author laurent
 */
class WorkDateModel extends AModel{
    //view
    ...
    public function set_workDateName($_workDateName) {
        $this->_workDateName[] = $_workDateName;
    }

    public function set_dateOn($_dateOn) {
        $this->_dateOn[] = $_dateOn;
    }

    public function set_dateOff($_dateOff) {
        $this->_dateOff[] = $_dateOff;
    }
