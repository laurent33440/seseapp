...
/**
 * Description of SchoolDefinitionBuilder
 *
 * @author prog
 */
class SchoolDefinitionBuilder extends AViewBuilder {
    public function __construct($params) {
        parent::__construct('SchoolDefinition', $params);
    }
    ...
    public function BuildBody($params){
            $body = TemplateHandler::getTemplate('SchoolDefinition');
