...
/**
 * Description of GeneralReferenceDefinitionController
 *
 * @author prog
 */
class GeneralReferenceDefinitionController extends AControllerState{
        ...
        try{
            ...
            switch ($this->_state){
                ...
                case self::RUNNING:
                    ...
                    break;
                case self::STOPPED:
                    $this->_model->getReferentialFromDataBase(); // retrive datas 
                    $this->ShowModelView(null); 
                    $this->_state = self::RUNNING;
                    break;
